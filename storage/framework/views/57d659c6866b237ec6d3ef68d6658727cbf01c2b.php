...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md">
            <div class="container">
                <a class="navbar-brand" class="header" href="<?php echo e(url('/')); ?>"><img class="d-inline-block align-text-center" src="\public\assets\img\logo.png" width="10%" height="10%">Web-Zoo</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('info')); ?>"><?php echo e(__('Инфо')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e(route('rules')); ?>"><?php echo e(__('Правила')); ?></a>
                        </li>
